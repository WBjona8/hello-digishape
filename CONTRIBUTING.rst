...
Welcome to ``hello-digishape`` contributor's guide.
...
If you experience bugs or general issues with ``hello-digishape``, please have a look
...
You can help improve ``hello-digishape`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``hello-digishape`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``hello-digishape``'s files. While this mechanism can
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/hello-digishape.git
    cd hello-digishape
...
#. Install |pre-commit|_::
   ...
   ``hello-digishape`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/hello-digishape
.. _issue tracker: https://github.com/<USERNAME>/hello-digishape/issues
.. <-- end -->
